-- this is only for destructed hex, fuck off
...
freeze.Name = "freeze"
freeze.Parent = scripts
freeze.BackgroundColor3 = Color3.fromRGB(53, 53, 53)
freeze.BorderSizePixel = 0
freeze.Size = UDim2.new(0, 200, 0, 50)
freeze.Font = Enum.Font.Roboto
freeze.Text = "Freeze"
freeze.TextColor3 = Color3.fromRGB(255, 255, 255)
freeze.TextSize = 14.000

giant.Name = "giant"
giant.Parent = scripts
giant.BackgroundColor3 = Color3.fromRGB(53, 53, 53)
giant.BorderSizePixel = 0
giant.Size = UDim2.new(0, 200, 0, 50)
giant.Font = Enum.Font.Roboto
giant.Text = "Giant"
...
cmds = "kill, sink, freeze, giant, punish, ragdoll, nolimbs, rclothes, ranims, rtools, rsit, rmap, hatless, faceless, kick, ban, unban, shutdown, slock, unslock, nuke, admin"
prefix = ":"
...
if args[1] == prefix.."kill" or args[1] == prefix.."respawn" or args[1] == prefix.."unfreeze" then
...
elseif args[1] == prefix.."giant" then
for i,v in pairs(GetPlayer(args[2])) do
task.spawn(function()
...
game:GetService("ReplicatedStorage"):WaitForChild("DefaultChatSystemChatEvents"):WaitForChild("SayMessageRequest"):FireServer(unpack(msg))
end
...
NewGuiPart109.Text = "011_luq , Script Made By Advancedev"
